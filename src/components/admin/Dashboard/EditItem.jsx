...
export default function AddItem() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`https://menu-project-ks8n.onrender.com/api/v1/items/update/${id}`, formData, {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex justify-center px-4 py-1">
            <div className="w-full max-w-5xl bg-white p-6 shadow-md  space-y-2">
                <Link to={`/admin/allitem/${categoryId}`}><KeyboardBackspaceIcon fontSize="large" className=' w-full border border-gray-500 p-1 cursor-pointer rounded-3xl' />
                </Link>
