    ...
    const fetchItems = async () => {
        try {
            const res = await axios.get(
                `https://menu-project-eta.vercel.app/api/v1/items/get/${categoryId}`, { withCredentials: true }
            );
            if (res.data.success) {
    ...
    const handleDelete = async (itemId) => {
        try {
            const res = await axios.delete(
                `https://menu-project-eta.vercel.app/api/v1/items/delete/${itemId}`, { withCredentials: true }
            );
            if (res.data.success) {
                fetchItems();
