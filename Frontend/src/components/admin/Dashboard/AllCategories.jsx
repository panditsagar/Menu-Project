...
const AllCategories = () => {
  ...
  const fetchCategories = async () => {
    ...
    try {
      const res = await axios.get('https://menu-project-v4c5.vercel.app/api/v1/categories/getall', { withCredentials: true });
      if (res.data.success) {
  ...
  const handleDelete = async (categoryId) => {
    try {
      const res = await axios.delete(
        `https://menu-project-v4c5.vercel.app/api/v1/categories/delete/${categoryId}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://menu-project-v4c5.vercel.app/api/v1/categories/post",
        formData,
        {
